...
#warning 修改了颜色和字体大小
    ...
    self.stateLabel.textColor = [UIColor colorWithRed:77/255.f green:77/255.f blue:77/255.f alpha:1];
    self.lastUpdatedTimeLabel.font = [UIFont systemFontOfSize:12];
    self.lastUpdatedTimeLabel.textColor = [UIColor colorWithRed:153/255.f green:153/255.f blue:153/255.f alpha:153/255.f];
